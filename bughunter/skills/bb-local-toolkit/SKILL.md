...
**Gate question:** Is an AI agent (Gemini CLI, Kiro CLI, Cline, Codex) invoked in a workflow where external users can influence the prompt?
...
# INSTALLATION (Kiro CLI Skill)

To use this as a Kiro CLI skill, copy this file to your skills directory:

```bash
# Option A: Clone the repo and link the skill
git clone https://github.com/shuvonsec/claude-bug-bounty.git ~/.kiro/skills/bughunter/bug-bounty
ln -s ~/.kiro/skills/bughunter/bug-bounty/SKILL.md ~/.kiro/skills/bughunter/bug-bounty/SKILL.md

# Option B: Direct copy
mkdir -p ~/.kiro/skills/bughunter/bug-bounty
curl -s https://raw.githubusercontent.com/shuvonsec/claude-bug-bounty/main/SKILL.md \
  -o ~/.kiro/skills/bughunter/bug-bounty/SKILL.md
```

Then in Kiro CLI, this skill loads automatically when you ask about bug bounty, recon, or vulnerability hunting.
