...
```bash
# Local Kiro CLI install
cp SKILL.md ~/.kiro/skills/bughunter/offensive-osint/SKILL.md
cp scripts/secret_scan.py ~/.kiro/skills/bughunter/offensive-osint/scripts/secret_scan.py

# Or attach to any LLM project / API system prompt
```
