...
function Write-Banner {
    ...
    Write-Host "  │                                                    │" -ForegroundColor Magenta
    Write-Host "  │     Installing 10 agents in dependency order       │" -ForegroundColor Magenta
    Write-Host "  │                                                    │" -ForegroundColor Magenta
    ...
    Write-Host "  │     Layer 3: threat-model, security-architecture   │" -ForegroundColor Magenta
...
function Write-Summary {
    ...
    Write-Host "  │  ✓  All 10 agents installed successfully!          │" -ForegroundColor Green
    Write-Host "  │                                                    │" -ForegroundColor DarkGreen
    ...
    Write-Host "  │  /agent security-architecture → Design review      │" -ForegroundColor DarkGreen
