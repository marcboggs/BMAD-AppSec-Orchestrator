<#
.SYNOPSIS
    Installs the supply-chain Kiro agent.
.DESCRIPTION
    REQUIRES: secreview (for SCA baseline data).
#>
$ErrorActionPreference = "Stop"
$AgentName = "supply-chain"; $AgentLabel = "Supply Chain"; $AgentDesc = "Supply chain security analyst"
...
if (Test-Path $dep) { Write-Ok "secreview is installed" }
    ...
    Write-Info "Supply Chain uses secreview SCA output as baseline"
    Write-Host ""
